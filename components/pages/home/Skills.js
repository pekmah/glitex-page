  ...
  return (
    <section className="py-14 bg-white" id={"services"}>
      ...
      <h4
        ...
        data-aos="fade-up"
      >
        We’ve got the skills and workforce you{" "}
        <br className="hidden md:block" /> can rely on to push your business to
        the next level
      </h4>
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6 md:w-[80vw] lg:w-[90vw] w-[90vw] mx-auto">
        <SkillItem
          ...
          path={"/services/seo-companies-in-nairobi-kenya-0"}
        />
        <SkillItem
          className={` h-auto lg:min-h-[625px] `}
          icon={<Phone />}
          ...
          description={` Discover the leading Mobile App Development Company in Nairobi, Kenya - 
          Glitex Solutions Limited. Our proficient team specializes in Android and iOS mobile app development, 
          delivering top-tier solutions at competitive prices. Whether you're based in Nairobi, Kenya, 
