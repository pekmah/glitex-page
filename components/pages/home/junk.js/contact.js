      ...
      <div className="row section-header" data-aos="fade-up">
        <div className="col-full">
          ...
          <h1
            ...
            className="display-3 display-2--light"
          >
            Unlock a world of possibilities with us!
          </h1>
          <a
            style={{ marginTop: "0" }}
            href="mailto:business@glitexsolutions.co.ke"
          ...
          <div className="contact-info">
            ...
            <div className="cinfo">
              ...
              <p>
                ...
                <br />
                <a
                  href="mailto:info@glitexsolutions.co.ke"
                  className="__cf_email__"
                >
