...
const AreYouInSearch = ({ showBtn }) => {
  return (
    <div className={"bg-white pb-5"}>
          ...
          <div className="flex flex-col w-[85%] gap-4 md:gap-8">
            ...
            <div className="">
              <p className="text-base sm:text-lg">
                ...
                applications. At Glitex Solutions Limited, you not only get
                mobile application development services but also the right
                advises on how to implement your app and how to roll it out.
              </p>
              <br />
              <p className="text-base sm:text-lg">
                We have served many countries in the Africa continent and beyond
                the continent. We have our headquarters in Nairobi, Kenya.
                Contact us today.
              </p>
            </div>
            <div className="flex">
              <Button
                ...
                className={
                  "bg-primary w-48 text-secondary text-base md:text-lg mx-auto md:mx-0"
                }
                text={"Call us Today!"}
              />
            </div>
      ...
      {showBtn && (
        <a href="/services/mobile-app-developers-in-ethiopia-1">
          <div
            className={
