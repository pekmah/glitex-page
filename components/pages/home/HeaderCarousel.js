...
const HeaderCarousel = () => {
    return (
        ...
        >
            <div
                className="lg:px-8 md:px-16 sm:px-12 px-2 w-full lg:w-[90%] font-bold text-2xl md:text-5xl leading-[50px] md:leading-[70px] pt-5">
                <div className="">
          <span className=" text-primary">
                ...
                <div className="my-8">
                    ...
                    <ul className={"flex md:hidden justify-center py-5 z-40 gap-4"}>
                        <a href={"https://web.facebook.com/glitexsolutionslimited"}>
                            <li className={"w-10 h-10 border-2 border-primary rounded-full flex items-center p-0"}>
            ...
            <ul className={" hidden md:flex absolute top-0 bottom-0 right-10 z-20  flex-col justify-center gap-4"}>
                <a href={"https://web.facebook.com/glitexsolutionslimited"}>
                    <li className={"w-10 h-10 border-2 border-primary rounded-full flex items-center p-0"}>
                        <FaFacebookF className={"mx-auto text-white text-xl"}/>
                    </li>
