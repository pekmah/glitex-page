            ...
            <div className='lg:flex gap-2 text-white'>
                <div className='flex-1 flex flex-col gap-3'>
                    ...
                    <div className=''>
                        ...
                        <input name="name"
                               ...
                               minLength="2" required aria-required="true" style={{color: "whitesmoke"}} type='text'
                    ...
                    <div className=''>
                        ...
                        {/* input */}
                        <input style={{color: "whitesmoke"}} name="email"
                               onChange={e => handleChangeDataFn(e, setState)}
                    ...
                    <div className=''>
                        ...
                        {/* input */}
                        <input style={{color: "whitesmoke"}} name="subject"
                               onChange={e => handleChangeDataFn(e, setState)}
                ...
                <div className='  lg:h-auto flex flex-col flex-1 mt-6 lg:mt-0 lg:px-4 '>
                    <textarea style={{color: "whitesmoke"}}
                              ...
                              cols="50" required aria-required="true"></textarea>
                    ...
                    <div className={"flex"}>
                        ...
                        {loading &&
                            <div className={"flex justify-center w-full p-3 mt-2 rounded bg-[#ffffff10]"} role="status">
