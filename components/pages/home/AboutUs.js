...
const AboutUs = () => {
  return (
    ...
    >
      <h3 className="lg:text-5xl sm:text-3xl text-xl font-bold lg:leading-[60px] sm:leading-[50px] leading-10" data-aos="fade-up">
      ...
      <div className="flex gap-3 sm:gap-5 lg:gap-8 font-semibold about-stats" data-aos="fade-up">
