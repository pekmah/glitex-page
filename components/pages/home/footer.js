...
const Footer = () => {
  return (
    <section id="footer">
      <div
        className="p-8 lg:p-12 flex flex-col md:flex-row gap-4"
        data-aos="fade-up"
      >
        ...
        <div className="flex-[0.4] flex flex-col  gap-5 ">
          ...
          {/* Email */}
          <div className="">
            <h5 className="text-lg text-primary font-medium">Email us at</h5>
          ...
          {/* Contact us at: */}
          <div className="">
            <h5 className=" text-lg text-primary font-medium">Contact us at</h5>
