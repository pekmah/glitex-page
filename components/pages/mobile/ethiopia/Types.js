...
const Types = () => {
  return (
    ...
    >
      <div className="lg:px-20 md:px-16 sm:px-12 px-4 w-full font-bold text-2xl md:text-4xl flex items-center justify-center ">
      ...
      <div className="md:my-5 text-center">
        ...
        <div className="w-[90vw] text-black mx-auto">
          <p>
