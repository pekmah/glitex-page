  ...
  return (
    ...
    >
      ...
      <p className="md:my-6 lg:text-xl sm:text-lg w-[95%] lg:w-2/3 leading-8 lg:leading-9">
        Game development is the process of creating video games for various
        platforms, such as consoles, PCs, and mobile devices. It involves
        designing and coding game mechanics, creating game assets, and
