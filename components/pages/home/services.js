            ...
            <div className="row services-list block-1-2 block-tab-full">
                <div className="col-block service-item" data-aos="fade-up">
                    ...
                    <div className="service-text">
                        <h3 className="h2">Website Design, Development, Maintenance, Hosting</h3>
                ...
                <div className="col-block service-item" data-aos="fade-up">
                    ...
                    <div className="service-text">
                        <h3 className="h2">Mobile App Development (IOS and Android)</h3>
                        <p>Nemo cupiditate ab quibusdam quaerat impedit magni. Earum suscipit ipsum laudantium. Quo
                            delectus est. Maiores voluptas ab sit natus veritatis ut. Debitis nulla cumque veritatis.
                            Sunt suscipit voluptas ipsa in tempora esse soluta sint.
                        </p>
                ...
                <div className="col-block service-item" data-aos="fade-up">
                    ...
                    <div className="service-text">
                        <h3 className="h2">Search Engine Optimization</h3>
                        <p>Nemo cupiditate ab quibusdam quaerat impedit magni. Earum suscipit ipsum laudantium. Quo
                            delectus est. Maiores voluptas ab sit natus veritatis ut. Debitis nulla cumque veritatis.
                            Sunt suscipit voluptas ipsa in tempora esse soluta sint.
                        </p>
                ...
                <div className="col-block service-item" data-aos="fade-up">
                    ...
                    <div className="service-text">
                        <h3 className="h2">Educational Tools</h3>
                        <p>Nemo cupiditate ab quibusdam quaerat impedit magni. Earum suscipit ipsum laudantium. Quo
                            delectus est. Maiores voluptas ab sit natus veritatis ut. Debitis nulla cumque veritatis.
                            Sunt suscipit voluptas ipsa in tempora esse soluta sint.
                        </p>
                ...
                <div className="col-block service-item" data-aos="fade-up">
                    ...
                    <div className="service-text">
                        <h3 className="h2">E-Commerce Platforms</h3>
                        <p>Nemo cupiditate ab quibusdam quaerat impedit magni. Earum suscipit ipsum laudantium. Quo
                            delectus est. Maiores voluptas ab sit natus veritatis ut. Debitis nulla cumque veritatis.
                            Sunt suscipit voluptas ipsa in tempora esse soluta sint.
                        </p>
                ...
                <div className="col-block service-item" data-aos="fade-up">
                    ...
                    <div className="service-text">
                        <h3 className="h2">Social Platforms</h3>
                        <p>Nemo cupiditate ab quibusdam quaerat impedit magni. Earum suscipit ipsum laudantium. Quo
                            delectus est. Maiores voluptas ab sit natus veritatis ut. Debitis nulla cumque veritatis.
                            Sunt suscipit voluptas ipsa in tempora esse soluta sint.
                        </p>
