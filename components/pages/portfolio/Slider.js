...
function Card({ title, desc, imgs, link, handleFocus }) {
  return (
    <>
      <div
        className="card bg-primary w-[85vw] md:w-[80vw] m-2 rounded-lg px-5"
        onFocus={() => handleFocus()}
      >
          ...
          <div className=" hidden md:flex items-center justify-center flex-1 gap-2">
            {imgs?.map((img) => (
              <img
                src={img}
                alt="__"
                className="max-h-[415px] w-auto h-auto rounded-xl"
              />
            ))}
          </div>
          ...
          <div className="flex flex-col gap-2 md:gap-6 flex-1 justify-center">
            ...
            <div className="flex">
              <Link href={link}>
                <OutlinedButton
                  className={
                    "border-secondary text-secondary border-2 text-sm md:text-lg"
                  }
                  text={"View more"}
                />
              </Link>
...
const scrollList = [
  {
    key: "item 1",
    id: "#okapy",
    images: ["/images/portfolio/imgc.webp", "/images/portfolio/imgb.webp"],
  ...
  }, //okapy
  {
    ...
    id: "#okapy-driver",
    images: [
      "/images/portfolio/okapy-driver-1.webp",
      "/images/portfolio/okapy-driver-2.webp",
    ],
  ...
  }, //golf
  {
    ...
    desc: `Attorney Shield offers 24/7 access to attorneys who specialize in assisting you during police encounters. You can easily access their support by opening the app and requesting assistance. (You get connected to an Attorney via Video Call)`,
